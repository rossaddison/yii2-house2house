...
{
    //store downloaded json file somewhere on your computer eg. onedrive
    ...
    public function behaviors()
    {
        return [
           ...
           'access' => 
                            ...
                            'only' => ['index','translated','update','view'],
                            'rules' => [
                            [
                              'allow' => true,
                              'roles' => ['admin','support'],
    ...
    {
        if (($model = Translated::findOne($id)) !== null) {
            return $model;
        } else {
