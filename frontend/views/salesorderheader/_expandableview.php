...
<div class="salesorderheader-expandable-view">
    ...
    foreach ($rows as $key => $value)
    {
        ...
        if ($value['paid'] < $value['unit_price']) {
                    ...
                    $green_or_red = 'btn btn-danger';} 
                    else {
                    $paid_or_unpaid = "Paid";    
                   // $green_or_red = ['class' => 'btn btn-success'];}
                    $green_or_red = 'btn btn-success';}
        ...
        echo Html::tag('div',
             Html::tag('tr',
                 ...
                 ."</td><td>". 
                 Html::a($url3,$url2,['class' => 'btn btn-success','data-toggle'=>'tooltip','title'=>'Goto Google maps using this address.'])                 
                 ."</td><td>".
                 ...
                 ."</td><td>".
                 Html::a(preg_replace("/[^0-9]/", "",Company::findOne(1)->telephone),$url4,['class' => 'btn btn-warning','data-toggle'=>'tooltip','title'=>'Telephone number of Boss obtained from Company settings...telephone.'])                 
                 ."</td><td>".
                 $value['unit_price']
                 ."</td><td>".
                 $value['paid']
