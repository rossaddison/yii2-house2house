...
<button id="w131" class = "btn btn-info btn-lg" onclick="js:getTranslatedticks()" datatoggle="tooltip" title="<?php echo Yii::t('app','Do not select more than 50 messages to translate.') ?>"><?php echo Yii::t('app','Translate through Google (ticked)') ?></button>
<br>
<br>
<?php 
