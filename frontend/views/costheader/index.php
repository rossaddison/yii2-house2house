...
<?php
   $gridColumns = [
    ...
    [
            ...
            'attribute' => 'status',
            'value' => 'status',
            'filter'=> Html::activeDropDownList($searchModel,'status',ArrayHelper::map(Costheader::find()->orderBy('status')->asArray()->all(),'status','status'),['class'=>'form-control','prompt'=>'Please Select']),            
    ...
    'header' => 'Cost Date',
    'attribute' => 'cost_date',
    'filter'=> Html::activeDropDownList($searchModel,'cost_date',ArrayHelper::map(Costheader::find()->orderBy('cost_date')->asArray()->all(),'cost_date','cost_date'),['class'=>'form-control','prompt'=>'From']),      
    'hAlign' => 'center',
    'vAlign' => 'middle',
    'width' => '9%',
