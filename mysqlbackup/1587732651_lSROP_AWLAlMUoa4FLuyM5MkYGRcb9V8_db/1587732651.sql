...
-- Date: Fri, 24 Apr 2020 12:50:51 +0000
...
-- Dumped table `auth_item_child` with 253 row(s)
--
...
SET autocommit=0;
INSERT INTO `user` VALUES (1,'rossaddison','ZuMcndJCEwVulT2g7lzn8SrK6Vofik18','$2y$13$TjanwAT7nNo0vKbeGD/bY.P7Vhm4Peo/fJO4iJr5zl1S30WPG/ZgC',NULL,'ross.addison@bbqq.co.uk',3,'2020-04-17 17:28:38','2020-04-17 17:29:04',NULL,NULL,'2020-04-19 22:34:30',3);
...
SET autocommit=0;
INSERT INTO `works_employee` VALUES (1,'aaa','77777777777','Title','2020-04-10','Single','Male','2020-04-02','Paid per hour - Not Salaried',0,0,'','2020-04-17 18:16:07');
/*!40000 ALTER TABLE `works_employee` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `works_employee` with 1 row(s)
--
...
-- Dump completed on: Fri, 24 Apr 2020 12:50:51 +0000
