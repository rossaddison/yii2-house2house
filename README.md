...
**What is the structure of the database?** InnoDB using collation utf8mb4_unicode_ci running on mySQL. The tables works_salesorderheader and works_salesorderdetails for instance have been structured similar to Microsoft's Adventure Works making extensive use of foreign keys. Hence Yii2 is strong in this regard and therefore Yii2's relations in models are used extensively to facilitate easy loading and lazy loading which promotes an extremely quick retrieval of records.
