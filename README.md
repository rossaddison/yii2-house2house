...
**What php version should my shared hosting provider eg. one.com be able to offer?** php 7.4.1 and above as at 3rd April 2020 although I am currently testing it on php 7.4.4.  The composer.json that has been created has been fine tuned to a stable release. The composer.json can be replaced with composer_dev_version.json for development purposes.
