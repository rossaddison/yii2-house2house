...
1. **Database component connection 'db' for database hth_db:** On your host's (eg. One.com) Linux via eg. Putty - for your **main** database component called 'db' : 
   ...
   The migrate command will look at the db component contained in **common**/config/main-local.php and install the migrations to the  named database eg. h2h_db on your localhost or to your_domain_co_uk_db on your host using the commands which have been constructed in the ControllerMap in **console**/config/main.php eg. the command  
