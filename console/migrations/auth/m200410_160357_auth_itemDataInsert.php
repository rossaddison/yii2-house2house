...
class m200410_160357_auth_itemDataInsert extends Migration
{
    ...
    [
        ...
        'type' => '2',
        'description' => 'A user with this permission can setup a non administration database in the range db1 - db10 which just has the essential Works Database files in it ie. works_salesorderheader etc.     Roles  Mdb only.',
        'rule_name' => null,
        'data' => null,
        'created_at' => '1586534378',
        'updated_at' => '1586534378',
    ],
    [
        'name' => 'See Prices',
        'type' => '2',
